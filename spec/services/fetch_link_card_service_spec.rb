...
RSpec.describe FetchLinkCardService do
  ...
  context 'with a remote status' do
    let(:status) do
      ...
      #<span class="tag"><a href="https://quitter.se/tag/wannacry" target="_top" rel="tag noopener" title="https://quitter.se/tag/wannacry">Wannacry</a></span> herumfliegen?
      Ich will mal unter <br> <a href="http://example.com/not-found" target="_top" rel="noopener" title="http://example.com/not-found">http://example.com/not-found</a> was sammeln. !
      <a href="http://sn.jonkman.ca/group/416/id" target="_top" rel="noopener" title="http://sn.jonkman.ca/group/416/id">security</a>&nbsp;
      TEXT
    end
