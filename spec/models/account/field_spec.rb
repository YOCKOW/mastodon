  ...
  describe '#verifiable?' do
    ...
    context 'with remote accounts' do
      ...
      context 'with a link' do
        let(:value) { '<a href="https://www.patreon.com/mastodon" target="_top" rel="nofollow noopener me"><span class="invisible">https://www.</span><span class="">patreon.com/mastodon</span><span class="invisible"></span></a>' }
      ...
      context 'with a link with misleading authentication' do
        let(:value) { '<a href="https://google.com                                                                                            @h.43z.one" target="_top" rel="nofollow noopener me"><span class="invisible">https://</span><span class="">google.com</span><span class="invisible">                                                                                            @h.43z.one</span></a>' }
      ...
      context 'with HTML that has more than just a link' do
        let(:value) { '<a href="https://google.com" target="_top" rel="nofollow noopener me"><span class="invisible">https://</span><span class="">google.com</span><span class="invisible"></span></a>                                                                                            @h.43z.one' }
