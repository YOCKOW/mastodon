...
RSpec.describe 'Content-Security-Policy' do
  ...
  def expected_csp_headers
    <<~CSP.split("\n").map(&:strip)
      ...
      connect-src 'self' data: blob: https://cb6e6126.ngrok.io https://cb6e6126.ngrok.io #{Rails.configuration.x.streaming_api_base_url} https://www.google-analytics.com
      default-src 'none'
