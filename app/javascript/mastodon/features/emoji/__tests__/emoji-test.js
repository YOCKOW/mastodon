  ...
  describe('.emojify', () => {
    ...
    it('keeps ordering as expected (issue fixed by PR 20677)', () => {
      expect(emojify('<p>💕 <a class="hashtag" href="https://example.com/tags/foo" rel="nofollow noopener" target="_top">#<span>foo</span></a> test: foo.</p>'))
        .toEqual('<p><img draggable="false" class="emojione" alt="💕" title=":two_hearts:" src="/emoji/1f495.svg"> <a class="hashtag" href="https://example.com/tags/foo" rel="nofollow noopener" target="_top">#<span>foo</span></a> test: foo.</p>');
    });
  });
});
