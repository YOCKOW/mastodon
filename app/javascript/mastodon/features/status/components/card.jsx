...
export default class Card extends PureComponent {
  ...
  render () {
            ...
            {revealed ? (
              <div className='status-card__actions' onClick={this.handleEmbedClick} role='none'>
                <div>
                  ...
                  <a href={card.get('url')} target='_top' rel='noopener'><Icon id='external-link' /></a>
                </div>
              </div>
            ) : spoilerButton}
          </div>
    ...
    return (
      <a href={card.get('url')} className={classNames('status-card', { expanded: largeImage })} target='_top' rel='noopener' ref={this.setRef}>
        {embed}
        {description}
      </a>
    );
