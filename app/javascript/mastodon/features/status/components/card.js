...
export default class Card extends React.PureComponent {
  ...
  render () {
    ...
    const title       = interactive ? <a className='status-card__title' href={card.get('url')} title={card.get('title')} rel='noopener' target='_top'><strong>{card.get('title')}</strong></a> : <strong className='status-card__title' title={card.get('title')}>{card.get('title')}</strong>;
    const ratio       = card.get('width') / card.get('height');
            ...
            {revealed && (
              <div className='status-card__actions'>
                <div>
                  ...
                  {horizontal && <a href={card.get('url')} target='_top' rel='noopener'><Icon id='external-link' /></a>}
                </div>
              </div>
            )}
    ...
    return (
      <a href={card.get('url')} className={className} target='_top' rel='noopener' ref={this.setRef}>
        {embed}
        {description}
      </a>
    );
