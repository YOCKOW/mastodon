      ...
      <div className='link-footer'>
        <p>
          ...
          {statusPageUrl && (
            <>
              {DividingCircle}
              <a href={statusPageUrl} target='_top' rel='noopener'><FormattedMessage id='footer.status' defaultMessage='Status' /></a>
            </>
          )}
          {canInvite && (
            <>
              {DividingCircle}
              <a href='/invites' target='_top'><FormattedMessage id='footer.invite' defaultMessage='Invite people' /></a>
            </>
          )}
          {canProfileDirectory && (
            <>
